                      ...
                      selectedMessage._id === conversation._id ? (
                        ...
                        <div className="">
                          ...
                          >
                            ...
                            <div className="flex  right-4 bottom-5  relative">
                              {conversation.messages &&
                                conversation.messages.length &&
...

{
  /* <div className="text-sm text-gray-500 ml-2">
                            ...
                            <div className="flex flex-col">
                              {getAllMessageIds(conversation).map(
                                (messageId, index) => (
                                  <span key={index}>{messageId}</span>
                                )
                              )}
                            </div>
                          </div> */
...
{
  /* <div className="text-sm text-gray-500 ml-2">
                            <span>Messages with seenMessage:</span>
                            <div className="flex flex-col">
                              {getMessagesWithSeenMessage(conversation).map(
                                (message) => (
                                  <div key={message._id}>
                                    <p>{message.message}</p>
                                  </div>
